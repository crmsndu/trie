...
class TestRouterFromArgsKitchenSink:
    ...
    def test_kitchen_sink_passes_every_field(self):
        ...
        args = RouterArgs(
            ...
            prefill_response_header_timeout_secs=90,
        ...
        assert router._router.prefill_response_header_timeout_secs == 90
...
class TestNewBindingFields:
    ...
    def test_http_pool_defaults(self):
        args = RouterArgs()
        assert args.prefill_response_header_timeout_secs == 120
    ...
    def test_http_pool_via_cli(self):
        ...
        args = parse_router_args(
            [
                ...
                "120",
                "--prefill-response-header-timeout-secs",
                "90",
        ...
        assert args.prefill_response_header_timeout_secs == 90
