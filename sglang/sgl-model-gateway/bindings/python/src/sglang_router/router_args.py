...
class RouterArgs:
    ...
    prefill_response_header_timeout_secs: int = 120
    ...
    def add_cli_args(
        ...
        request_group.add_argument(
            f"--{prefix}prefill-response-header-timeout-secs",
            type=int,
            default=RouterArgs.prefill_response_header_timeout_secs,
            help="PD-only timeout for sending a prefill request and receiving response headers",
        )
        request_group.add_argument(
