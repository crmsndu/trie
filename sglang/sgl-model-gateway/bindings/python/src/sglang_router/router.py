...
class Router:
    ...
    Args:
        ...
        request_timeout_secs: Request timeout in seconds. Default: 1800
        prefill_response_header_timeout_secs: PD-only timeout for sending a prefill request and
            receiving response headers. This does not limit decode streaming. Default: 120
