...
pub const DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS: u64 = 120;
...
pub struct RouterConfig {
    ...
    /// PD-only deadline for sending a prefill request and receiving its response headers.
    /// Decode response bodies and streams are governed by `request_timeout_secs` instead.
    #[serde(default = "default_prefill_response_header_timeout_secs")]
    pub prefill_response_header_timeout_secs: u64,
...
fn default_prefill_response_header_timeout_secs() -> u64 {
    DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS
}
...
impl Default for RouterConfig {
    fn default() -> Self {
        Self {
            ...
            prefill_response_header_timeout_secs: default_prefill_response_header_timeout_secs(),
...
mod tests {
    ...
    fn test_router_config_default() {
        ...
        assert_eq!(
            config.prefill_response_header_timeout_secs,
            DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS
        );
    ...
    fn test_router_config_http_client_deserialization_defaults() {
        ...
        json_object.remove("prefill_response_header_timeout_secs");
        ...
        assert_eq!(
            deserialized.prefill_response_header_timeout_secs,
            DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS
        );
    }
