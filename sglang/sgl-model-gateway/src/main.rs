...
use smg::{
    ...
    config::{
        ...
        DEFAULT_POOL_MAX_IDLE_PER_HOST, DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS,
...
struct CliArgs {
    ...
    /// PD-only timeout for sending a prefill request and receiving response headers
    #[arg(
        long,
        env = "SMG_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS",
        default_value_t = DEFAULT_PREFILL_RESPONSE_HEADER_TIMEOUT_SECS,
...
impl CliArgs {
    ...
    fn to_router_config(
        ...
        let builder = RouterConfig::builder()
            ...
            .prefill_response_header_timeout_secs(self.prefill_response_header_timeout_secs)
