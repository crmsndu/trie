...
class ModelRunnerKVCacheMixin:
    ...
    def calculate_mla_kv_cache_dim(self: ModelRunner) -> int:
        ...
        return DSATokenToKVPool.calculate_kv_cache_dim(
            kv_lora_rank=kv_lora_rank,
            qk_rope_head_dim=qk_rope_head_dim,
            kv_cache_dtype=self.kv_cache_dtype,
            dsa_prefill_backend=self.server_args.dsa_prefill_backend,
            dsa_decode_backend=self.server_args.dsa_decode_backend,
    ...
    def _init_pools(self: ModelRunner):
        ...
        if is_dsv4_model:
            ...
            if self.enable_hisparse:
                ...
                pool_kwargs["index_layer_ids"] = (
                    list(range(self.start_layer, self.end_layer))
                    if self.is_draft_worker
                    else get_dsa_index_producer_layer_ids(
